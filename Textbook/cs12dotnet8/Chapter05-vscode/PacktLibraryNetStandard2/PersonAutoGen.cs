...
public partial class Person
{
  ...
  private string? _favoritePrimaryColor { get; set; }
  ...
  public WondersOfTheAncientWorld _favoriteAncientWonder;
  ...
  public WondersOfTheAncientWorld FavoriteAncientWonder
  {
    ...
    set
    {
      ...
      {
        throw new ArgumentException($"{value} is not a member of the WonderOfTheAncientWorld enum.", paramName: nameof(FavoriteAncientWonder));
      }
