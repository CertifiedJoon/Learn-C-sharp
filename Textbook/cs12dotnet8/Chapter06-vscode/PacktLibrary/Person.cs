...
public class Person : IComparable<Person?>
{
  ...
  /// <summary>
  /// Static method to "multiply aka procreate and have a child together.0
  /// </summary>
  ...
  public static Person Procreate(Person p1, Person p2)
  {
    ...
    if (!p1.Spouses.Contains(p2) && !p2.Spouses.Contains(p1))
    {
      throw new ArgumentException(string.Format("{0} must be married to {1} to procreate with.", arg0: p1.Name, arg1: p2.Name));
    }
